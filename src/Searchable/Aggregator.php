...
use ElasticScoutDriverPlus\Exceptions\ModelNotDefinedInAggregatorException;
...
abstract class Aggregator extends Model
{
    use Searchable;
     ...
     *
     * @return ElasticScoutDriverPlus\Searchable\Aggregator
     */
     ...
     *
     * @throws ElasticScoutDriverPlus\Exceptions\ModelNotDefinedInAggregatorException
     */
     ...
     * @return  array
     */
    public function getRelations($modelClass = null): array
    {
    ...
    /**
     * Use soft deleted status of model
     *
     * @return \ElasticScoutDriverPlus\Searchable\Aggregator
     */
    public function pushSoftDeleteMetadata()
    {
        return $this->withScoutMetadata('__soft_deleted', $this->model->trashed() ? 1 : 0);
    }
